...
/*======================================================不在线===================================================================*/
function update_device_online_no($db,$apiurl,$apikey,$type,$types){
    ...
    //更新所有已经在线的设备
    $imp  = "'" . implode("','", $array) . "'"  ;
    $update_sql = "update device_relation_group set online_status = 0 where  del_flag=0 and  device_command in($imp) and  device_type in ($types)";
    ...
    if($result2){
        echo(json_encode(array('code'=>200,'msg'=>$type .'___更新成功')));
    }else{
        echo (json_encode(array('code'=>500,'msg'=>$type.'___更新失败')));
    }
}
//不在线设备更新
update_device_online_no($db,$apiurl,$apikey_wwj,'1',"'1'");
update_device_online_no($db,$apiurl,$apikey_amy,'2',"'4'");
update_device_online_no($db,$apiurl,$apikey2,'3',"'2'");
update_device_online_no($db,$apiurl,$apikey3,'4',"'3'");
update_device_online_no($db,$apiurl,$apikeyxiaoqu,'6',"'6'");
update_device_online_no($db,$apiurl,$apikeyxiche,'7',"'7'");
update_device_online_no($db,$apiurl,$apikeyxi,'5',"'5'");
update_device_online_no($db,$apiurl,$apikeycezhiji,'8',"'8'");
update_device_online_no($db,$apiurl,$apikeydangducezhiji,'8',"'8'");
update_device_online_no($db,$apiurl,$apikeyyanbaoyi,'9',"'9'");
update_device_online_no($db,$apiurl,$apikeychaxie,'11',"'11'");