...
class iAuth{
    ...
    public function check($uid,$name,$relation='or') {
        ...
        $groups=$role_user_model->alias("a")->join($role_user_join)->where(array("a.user_id"=>$uid,"b.useable"=>1))->getField("a.role_id");
        //p($groups);die;
        /*if(!empty($groups)){
        	return true;
        }*/
        ...
        $auth_access_model=M("auth_access");
        ...
        //echo $auth_access_model->alias("a")->getlastsql();die;
    ...
    private function getUserInfo($uid) {
    	...
    	if(!isset($userinfo[$uid])){
    		$userinfo[$uid]=M("sys_user")->where(array('id'=>$uid))->find();
    	}
    	return $userinfo[$uid];
    }
