<?php if (!defined('THINK_PATH')) exit(); if($Week_Region_Randing != null): ?><ul>
        <?php if(is_array($Week_Region_Randing)): $k = 0; $__LIST__ = $Week_Region_Randing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if($k <= 10): ?><li <?php if(isset($v['my_pai'])){echo "class='user'";} ?>>
