...
* @Date:   2015-09-24 16:50:25
* @Last Modified by:   wapwei
* @Last Modified time: 2015-10-12 19:20:40
*/
...
$(function(){
	...
	//确认收到显示弹出
	$(".course-affirm:last").click(function(){
		$("#reminder").addClass('is-visible')
	})
	$(".course-affirm:first").click(function(){
	...
	$(".Mask-pull-down-ul-li").touch(function(){
		var text = $(this).html();
