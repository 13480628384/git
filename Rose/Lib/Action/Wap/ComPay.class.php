...
class ComPay {
    //证书
    private $apiclient_cert = '/home/wwwroot/wxpay.roseo2o.com/Rose_test/Lib/Action/Wap/cert/apiclient_cert.pem';
    private $apiclient_key = '/home/wwwroot/wxpay.roseo2o.com/Rose_test/Lib/Action/Wap/cert/apiclient_key.pem';
    //pay的秘钥值
    private $apikey = "BA01B5A812474D21B585F1D27A52636D";
    //错误信息
    private $error = '';
    private $mchid = '1379294702';//商户号
    private $mchappid = 'wx6a9d4afeace38e53';//公众号
    private $openid;//接收者openid
    private $amount = 100;//金额
    private $partnertradeno = '';//订单号
    private $spbillcreateip = '120.24.36.63';//触发ip
    private $checkname = 'NO_CHECK';//校验要求
    private $sendname = '深圳玫瑰物联';
    private $wishing = '恭喜您';
    private $actname = '我的收益';
     ...
     *@return boolean
     */
    public function RedBag($amount,$openid){
        if(!$this->inited($amount)) return false;
        $obj = array();
     ...
     *@return boolean
     */
    private function inited($amount){
        $inited = true;
