<?php
//按摩椅
class AnmAction extends BackAction{
    ...
    protected function _initialize(){
        ...
        if( strpos($typesd,'MicroMessenger')>0 ){
            ...
            //echo M('weixin_pay_rec')->getLastSql().'<hr>';echo M('device_consume_rec')->getLastSql();die;
            $count = $total1-$total2;
        ...
        $dgi = M('device_relation_group')->where(array('di_id'=>$device_info['id'],'del_flag'=>0,'device_type'=>4))->find();
