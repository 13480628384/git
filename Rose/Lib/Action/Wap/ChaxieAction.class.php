<?php
//纸
class ChaxieAction extends BackAction{
    ...
    protected function _initialize(){
        ...
        $dgi = M('device_relation_group')->where(array('di_id'=>$device_info['id'],'del_flag'=>0,'device_type'=>'11'))->find();
        //$new = implode('=',explode('-',$dgi['charger']));
        $out = explode('-',$dgi['charger']);
