...
class WxPayResults extends WxPayDataBase
{
     ...
     * @throws WxPayException
     */
	public static function sub_Init($xml)
	{	
		$obj = new self();
		$obj->FromXml($xml);
		//fix bug 2015-06-29
...
{	
	...
	**/
	 ...
	 * @param string $value
	 **/
	public function SetSub_Mch_id($value)/*-----------2016-03-30 author chw -----------*/
	{
	...
	public function SetMch_appid($value)/*-----------2016-03-30 author chw -----------*/
	{
