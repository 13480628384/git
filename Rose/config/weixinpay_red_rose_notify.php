...
if($notify->checkSign() == TRUE)
{
    ...
    elseif($notify->data["result_code"] == "FAIL"){
        ...
        //此处应该更新一下订单状态，商户自行增删操作
        $cid = $db->query("update rose_eco_business_recharge_record set pay_status=1,transaction_id='$paydata[transaction_id]' where type=5 and out_trade_no='$paydata[out_trade_no]' and user_id='$paydata[openid]'");
