...
<div class="facility">
    <table width="100%" align="center" class="loading">
        <tr >
            <td width="25%" height="73" align="center" valign="middle" bgcolor="#2ebf74" class="style1">类型</td>
            <td width="25%" height="73" align="center" valign="middle" bgcolor="#2ebf74" class="style1">数额</td>
            <td width="25%" height="73" align="center" valign="middle" bgcolor="#2ebf74" class="style1">时间</td>
            <td width="25%" height="73" align="center" valign="middle" bgcolor="#2ebf74" class="style1 style2">设备号</td>
        </tr>
        <?php if(is_array($line_list)): $i = 0; $__LIST__ = $line_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
