...
<section class="ucenter-main animated fadeInDown">
    ...
    <ul class="um-list um-list-form" id="J_chooseProject">
        <li><label class="label">退款金额</label><input type="text"  id="customer_project" readonly="readonly" class="color-blue"  value="<?php echo ($total); ?>"></li>
    </ul>
    <div class="space-10"></div>
...
<input type="hidden" class="total" value="<?php echo ($total); ?>"/>
