    ...
    <div id="tabbox">
        <ul class="tabs" id="tabs">
            <div class="tabs_return">
                <a href="<?php echo U('index',array('buyer_id'=>$buyer_id,'device_code'=>$device_code));?>">
                    返回</a></div>
            <li class="thistab">消费记录</li>
            <li><a href="<?php echo U('rose_pay',array('buyer_id'=>$buyer_id,'device_code'=>$device_code));?>">我的玫瑰</a></li>
        ...
        <ul class="tab_conbox" id="tab_conbox">
            <li class="tab_con ">
                <div class="tab_date">
                    ...
                    <div class="tab_dev1" style="width: 40%;text-align: center;background: #fff;color: #f57789;font-size: 1.5rem;">消费状态</div>
                    <div class="tab_ear1" style="width: 30%;background: #fff;color: #f57789;font-size: 1.5rem;">消费时间</div>
                </div>
                <div style="height: 0.5rem; background: #f2f2f2"></div>
