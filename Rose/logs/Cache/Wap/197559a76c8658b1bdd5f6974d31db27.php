                ...
                <div class="item-content">
                    ...
                    <div class="item-inner">
                        ...
                        <div class="item-input">
                            <input type="text" value="" id="amount"  style="float: left; width: 64%;" placeholder="￥提现金额"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
                            <tt class="ti"> 余额<span id="outtip"><?php echo ($car_pay); ?></span></tt>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="item-content">
                    ...
                    <div class="item-inner">
                        ...
                        <div class="item-input">
                            <input type="text" value="" style="width:50%;float: left"  pattern="[0-9]*" id="code"  placeholder="请输入验证码" >
...
<script type="text/javascript" src="./tpl/Wap/default/js/car_cash.js?1276"></script>
<script>
