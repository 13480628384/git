...
<head>
    ...
    #launch .botton2 {
        ...
        .lion{
        background: url(./tpl/Wap/default/img/anm1.png)!important;
        }
    </style>
</head>
<!--加的-->
...
<!--加的-->
<a href="#"><img src="./tpl/Wap/default/img/anm3.png" width="100%"></a>
...
<section style="margin-top: 10px;">
    <ul id="launch" style=" padding-bottom:100px; text-align: center;" class="Rose_xyj_staty">
        <div class="botton2" times="<?php echo ($out["1"]); ?>" price="<?php echo ($out["0"]); ?>" cd="A">
            支付<?php echo ($out["0"]); ?>元 按摩<?php echo ($out["1"]); ?>分钟
            <tt id="zimuA" class="z1" style="display: none">0</tt>
        </div>
        <div class="botton2" times="<?php echo ($out["3"]); ?>" price="<?php echo ($out["2"]); ?>" cd="B">
            支付<?php echo ($out["2"]); ?>元 按摩<?php echo ($out["3"]); ?>分钟
            <tt id="zimuB" class="z1" style="display: none">0</tt>
        </div>
        <div class="botton2" times="<?php echo ($out["5"]); ?>" price="<?php echo ($out["4"]); ?>" cd="C">
            支付<?php echo ($out["4"]); ?>元 按摩<?php echo ($out["5"]); ?>分钟
            <tt id="zimuC" class="z1" style="display: none">0</tt>
        </div>
        <div style="text-align: center; font-size: 30px;">服务电话:<?php echo ($phone); ?></div>
    </ul>
</section>
<p class="call_wx">
...
<input type="hidden" class="washing_pay" value="<?php echo U('CommonWeixin/anm_pay');?>">
    ...
    $(document).ready(function(){
        ...
        $(".Rose_xyj_staty .botton2").click(function() {
            ...
            if(three>=2 || $(this).is(".one") ||$(this).is(".onete")){
                ...
                $(".Rose_xyj_staty .botton2").addClass('on');
                $.post("<?php echo U('AlipayCommon/anm_start');?>",dat,function(data){
                    if(data.code == 200){
                        alert(data.msg);
    ...
    * */
    $('.weixinpay').click(function(){
        ...
        if(weixin_alipay_type == 'wechat'){
                    ...
                    WeixinJSBridge.invoke(
                            ...
                            function(res){
                                ...
                                if(res.err_msg == "get_brand_wcpay_request:ok" ){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: "<?php echo U('CommonWeixin/anm_update');?>",
                                        data: {
            ...
            post("<?php echo U('AlipayCommon/anm_pay');?>",datae)
        }
    });
    $('.cash').click(function(){
