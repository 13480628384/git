...
<head>
    ...
    <title>流水报表</title>
    <style>
    .tab-yf-box-main-name,.tab_ear1{width:25%;}
    </style>
</head>
<body>
<div class="report_forms">
    <div id="tabbox">
        <ul class="tabs" id="tabs">
            ...
            <li style="width: 60%;color: #2EBE74;height: 3rem;font-size: 2rem;">一周(<?php echo ($group_name); ?>)</li>
            <div class="clear"></div>
        </ul>
            ...
            <li class="tab_con ">
                <?php if(is_array($balance)): $i = 0; $__LIST__ = $balance;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="height: 0.5rem; background: #f2f2f2"></div>
                    <div class="tab_date">
                        ...
                        <div class="tab_ear1"><a href="<?php echo U('week_group_device_deteil',array('openid'=>$openid,'di_id'=>$v['id']));?>">
