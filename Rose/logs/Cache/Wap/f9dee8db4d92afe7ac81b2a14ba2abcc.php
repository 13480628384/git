...
<div class="report_forms">
    <div id="tabbox">
        <ul class="tabs" id="tabs">
            ...
            <li><a href="<?php echo U('Rose2Orderflow/week_index',array('openid'=>$openid));?>">一星期</a></li>
...
<input type="hidden" class="month" value="<?php echo ($month); ?>">
    ...
    $(document).scroll(function(){
        ...
        if($(document).height() - $(window).scrollTop() < diff){
            ...
            timeOut = setTimeout(function(){//1秒加载一次
                var month = $('.month').val();
                $.post('',{"n": n,month:month},function(html){
