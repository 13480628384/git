...
<div class="facility">
    <table width="100%" align="center" class="loading">
        ...
        <?php if(is_array($weixin_list)): $i = 0; $__LIST__ = $weixin_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td width="30%" align="center" valign="middle" class="style3"><?php echo $v['create_date']; ?></td>
