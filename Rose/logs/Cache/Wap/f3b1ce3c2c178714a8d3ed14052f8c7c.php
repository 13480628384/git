...
<form id="base" class="file" action="<?php echo U('base_excel');?>" method="post" enctype="multipart/form-data">
...
<form id="myform" class="file" action="<?php echo U('excel');?>" method="post" enctype="multipart/form-data">
    <a href="#" class="a_button btn btn-primary">
...
<script>
    $(function(){
        ...
        $('.excel_down').click(function(){
            window.location.href='<?php echo U("download_excel");?>';
        });
        //退出
        $('.logout').click(function(){
            window.location.href='<?php echo U("logout");?>';
        });
        //下载添加设备模板
        $('.batch_down').click(function(){
            window.location.href='<?php echo U("batch_down");?>';
        });
