...
<head>
    ...
    <link rel="stylesheet" href="./tpl/Wap/default/css/game.css?0">
...
<input type="hidden" class="weixin_pay_update" value="<?php echo U('V_2WechatPay/weixin_pay_update');?>">
<input type="hidden" class="weixin_pay" value="<?php echo U('V_2WechatPay/weixin_pay');?>">
...
<input type="hidden" class="online_status" value="<?php echo U('online_status');?>">
...
<script type="text/javascript" src="./tpl/Wap/default/js/weixin_pay.js?2201"></script>
<script>
    $('.consume').click(function(){
       window.location.href="<?php echo U('WeixinUserConsume/index',array('openid'=>$openid));?>";
    });
