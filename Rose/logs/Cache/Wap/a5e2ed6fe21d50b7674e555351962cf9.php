    ...
    <ul class="list">
        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="subject_4 pbw">
                <div style="white-space:normal; ">
                    <p class="pl">时间：<?php echo ($v["create_date"]); ?> </p>
                    <b style="font-size: 16px;font-weight: 600;">金额：<?php echo ($v["pay_account"]); ?></b><br/>
                    支付单号：<?php echo ($v["out_trade_no"]); ?> <br/>
                    支付类型：微信<br/>
                    客户名称：<?php echo ($v["from_username"]); ?><br/>
                    提现结果：<?php if($v['pay_status'] == 1): ?><span style="color: #00bf00">成功</span>
