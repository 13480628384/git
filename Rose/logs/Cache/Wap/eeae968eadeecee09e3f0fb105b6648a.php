...
<div class="vip_run">
    ...
    <div class="vip_run_tab">
        <ul>
            <li class="no-open">运营商</li>
            <li class="adv active">广告商</li>
            <li class="vip_run_tabli2">生态商</li>
        </ul>
    </div>
    <div class="height20"></div>
    <div class="vip_run_con">
        <button class="anniu add_adv" type="button">广告添加</button>
        <ul>
            <li>
                <span class="vip_run_con_span1">昵称</span>
                <span class="vip_run_con_span2">
                    <a href="<?php echo U('V_2Rose/update_vip',array('user_id'=>$user_id,'weixin_alipay_type'=>$weixin_alipay_type,'scan_code'=>$scan_code));?>">
            ...
            <li>
                ...
                <span class="vip_run_con_span2">
                    <a href="<?php echo U('V_2Rose/update_vip',array('user_id'=>$user_id,'weixin_alipay_type'=>$weixin_alipay_type,'scan_code'=>$scan_code));?>"><?php echo ($rose["phone"]); ?>
                        <img class="vip_run_con_img1" src="./tpl/Wap/default/img/vip1.png" alt="">
                    </a>
                </span>
            </li>
            ...
            <li>
                ...
                <a href="<?php echo U('V_2Rose/yuncount',array('user_id'=>$user_id,'weixin_alipay_type'=>$weixin_alipay_type,'id'=>$rose['id'],'scan_code'=>$scan_code));?>">
            ...
            <li>
                <span class="vip_run_con_span1">黄玫瑰</span>
                <span class="vip_run_con_span2"><?php if($rose['yellow_rose'] == ''): ?>0<?php else: ?>
                    <?php echo ($rose["yellow_rose"]); endif; ?>
                    <img class="vip_run_con_img1" src="./tpl/Wap/default/img/vip1.png" alt="">
                </span>
            </li>
            <li>
            ...
            <li>
                ...
                <span class="vip_run_con_span2">
                    <a href="<?php echo U('V_2Rose/vash',array('user_id'=>$user_id,'weixin_alipay_type'=>$weixin_alipay_type,'id'=>$rose['id'],'scan_code'=>$scan_code));?>">
    ...
    <?php if(is_array($rose_adv)): $k = 0; $__LIST__ = $rose_adv;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if($v['count'] == 2): ?><p class="startp1 vip_run_endp" dataid="<?php echo ($v["id"]); ?>" dataurl="<?php echo ($v["url"]); ?>" style="border-bottom: solid 1px #f2f2f2"><?php echo ($v["title"]); ?></p><?php endif; endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<script>
    ...
    $('.vip_run_tabli2').click(function(){
        window.location.href="<?php echo U('V_2Rose/vip_personal',array('weixin_alipay_type'=>$weixin_alipay_type,'user_id'=>$user_id,'scan_code'=>$scan_code));?>";
    });
    $('.add_adv').click(function(){
        window.location.href="<?php echo U('Adv/adv',array('weixin_alipay_type'=>$weixin_alipay_type,'user_id'=>$user_id,'scan_code'=>$scan_code));?>";
    });
