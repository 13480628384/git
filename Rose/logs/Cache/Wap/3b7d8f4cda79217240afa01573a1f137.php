...
<div class="width750">
	...
	<div class="botton_cdqd weixin_pay" dataprice="<?php echo ($out["0"]); ?>" datatime="<?php echo ($out["1"]); ?>">支付<?php echo ($out["0"]); ?>元 购买<?php echo ($out["1"]); ?>件 </div>
    <div class="botton_cdqd weixin_pay" dataprice="<?php echo ($out["2"]); ?>" datatime="<?php echo ($out["3"]); ?>">支付<?php echo ($out["2"]); ?>元 购买<?php echo ($out["3"]); ?>件 </div>
...
<input type="hidden" class="weixin_pay_machine" value="<?php echo U('WeixinPay/weixin_machine_pay');?>">
        ...
        WeixinJSBridge.invoke(
                ...
                function(res){
                    ...
                    if(res.err_msg == "get_brand_wcpay_request:ok" ){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo U('WeixinPay/weixin_machine_update');?>",
                            data: {
