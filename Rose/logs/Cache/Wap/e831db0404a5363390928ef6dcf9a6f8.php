...
<div id="wrapper">
    ...
    <div class="content">
        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input s_name" value="<?php echo ($res["name"]); ?>" type="text" placeholder="请输入商品名称">
                </div>
            </div>
        </div>
        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input s_ords" value="<?php echo ($res["ords"]); ?>" maxlength="3" type="number" placeholder="此处输入">
                </div>
            </div>
        </div>
        <div class="weui-cells__title">
        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input s_remarks" value="<?php echo ($res["remarks"]); ?>" type="text" placeholder="此处输入">
                </div>
            </div>
        </div>
        <ul class="imgList clearfix">
            <?php if($res['image'] != null): ?><li>
...
<input type="hidden" class="submit_content" value="<?php echo U('submit_update');?>">
<input type="hidden" class="add_img_upload" value="<?php echo U('add_img');?>">
<input type="hidden" class="id" value="<?php echo ($res["id)"]); ?>">
...
<script>
    Zepto(function($) {
        $('.new_submit').tap(function () {
            ...
            $.post(url, {name: name,id:id, select_id: select_id,ords:ords,remarks:remarks}, function (data) {
                el.hide();
                if (data.code == 200) {
                    var DG = $.dialog({
                        content: data.msg,
