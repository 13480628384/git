...
<div class="report_forms">
    <div id="tabbox">
        <ul class="tabs" id="tabs">
            <div class="tabs_return"><a href="<?php echo U('index',array('buyer_id'=>$buyer_id,'device_code'=>$device_code));?>">
                <!-- <img src="./tpl/Wap/default/img/left.png" alt="" width="30%">-->返回</a></div>
            <li><a href="<?php echo U('rose_consume',array('buyer_id'=>$buyer_id,'device_code'=>$device_code));?>">玫瑰消费</a></li>
            <li class="thistab">我的玫瑰</li>
            <div class="clear"></div>
        </ul>
        <ul class="tab_conbox" id="tab_conbox">
            <li class="tab_con ">
                <div class="tab_date">
                    ...
                    <div class="tab_num1" style="background: #fff;color:#f57789;font-size: 1.5rem;">金额</div>
                    <div class="tab_dev1" style="width: 40%;text-align: center;background: #fff;color: #f57789;font-size: 1.5rem;">状态</div>
                    <div class="tab_ear1" style="width: 30%;background: #fff;color: #f57789;font-size: 1.5rem;">时间</div>
                </div>
                <div style="height: 0.5rem; background: #f2f2f2"></div>
                <?php if(is_array($pay)): $i = 0; $__LIST__ = $pay;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="height: 0.5rem; background: #f2f2f2"></div>
                    <div class="tab_date">
                        <div class="tab_num1">  <?php echo ($v["account"]); ?></div>
                        <div class="tab_dev1" style="width: 40%;text-align: center;">
                            <?php if($v['status'] == 1): ?>成功
                                <?php elseif($v['status'] == 0): ?>失败<?php endif; ?>
                        </div>
