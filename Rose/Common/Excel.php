...
require('Common/phpoffice/phpexcel/Classes/PHPExcel.php');
require('Common/phpoffice/phpexcel/Classes/PHPExcel/Writer/Excel2007.php');
require('Common/phpoffice/phpexcel/Classes/PHPExcel/Style/NumberFormat.php');
require('Common/phpoffice/phpexcel/Classes/PHPExcel/Worksheet.php');
require('Common/phpoffice/phpexcel/Classes/PHPExcel/IOFactory.php');

class Excel {

    public static function arr2ExcelDownload($aArr, $aHead = null, $sName = null)
    {
        if (empty($aHead)) {
     ...
     */
    public static function arr2Excel(array $aArr, $sExcelName = "", $sExcelPath = "./") {
     ...
     */
    public static function arrHead2Excel(array $aArr, array $aHead = array(), $sExcelName = "", $sExcelPath = "./") {
     ...
     * @return \PHPExcel_Writer_Excel2007
     */
    public static function multiArr2Excel($sExcelName = "", $sExcelPath = "./", array $aArr) {
     ...
     * @return array
     */
    public static function excel2Arr($sFilePath, $bRemoveTitle = false, $sFileType = 'Excel2007', $iActiveSheetIndex = 0)
    {
     ...
     * @return string
     */
    public static function getExcelCol($iCol) {
        $sCol = '';
